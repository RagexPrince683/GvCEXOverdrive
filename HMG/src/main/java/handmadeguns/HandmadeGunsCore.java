...
public class HandmadeGunsCore {
	...
	public static boolean cfg_ClientCamera_MasterEnabled = true;
	public static boolean cfg_ClientCamera_RotationSmoothingEnabled = true;
	public static float cfg_ClientCamera_SmoothingStrength = 0.18F;
	public static float cfg_ClientCamera_MaxYawOffset = 3.0F;
	public static float cfg_ClientCamera_MaxPitchOffset = 3.0F;
	public static boolean cfg_ClientCamera_MotionTiltEnabled = true;
	...
	public static float cfg_ClientCamera_BobSpeed = 9.0F;
	public static float cfg_ClientCamera_SprintBobMultiplier = 1.25F;
	public static float cfg_ClientCamera_ADSBobMultiplier = 0.35F;
	public static boolean cfg_ClientCamera_FovInertiaEnabled = true;
	public static float cfg_ClientCamera_FovLerpSpeed = 0.12F;
	public static float cfg_ClientCamera_SprintFovBoost = 3.0F;
	public static float cfg_ClientCamera_ADSFovSpeed = 0.22F;
	public static boolean cfg_ClientCamera_ShakeEnabled = true;
	public static float cfg_ClientCamera_MaxShakePitch = 5.0F;
	...
	public static float cfg_ClientCamera_DamageShakeMultiplier = 0.7F;
	public static boolean cfg_ClientCamera_CustomHurtCameraEnabled = true;
	public static boolean cfg_ClientCamera_ReplaceVanillaHurtCamera = false;
	public static boolean cfg_ClientCamera_DebugCamera = false;
	...
	public void preInit(FMLPreInitializationEvent pEvent) {
		...
		String cameraCategory = "ClientCamera";
		cfg_ClientCamera_MasterEnabled = lconf.get(cameraCategory, "masterEnabled", true, "Master switch for the client-only first-person camera/recoil overhaul.").getBoolean(true);
		cfg_ClientCamera_RotationSmoothingEnabled = lconf.get(cameraCategory, "rotationSmoothingEnabled", true).getBoolean(true);
		cfg_ClientCamera_SmoothingStrength = (float) lconf.get(cameraCategory, "smoothingStrength", 0.18D).getDouble(0.18D);
		cfg_ClientCamera_MaxYawOffset = (float) lconf.get(cameraCategory, "maxYawOffset", 3.0D).getDouble(3.0D);
		cfg_ClientCamera_MaxPitchOffset = (float) lconf.get(cameraCategory, "maxPitchOffset", 3.0D).getDouble(3.0D);
		cfg_ClientCamera_MotionTiltEnabled = lconf.get(cameraCategory, "motionTiltEnabled", true).getBoolean(true);
		...
		cfg_ClientCamera_BobSpeed = (float) lconf.get(cameraCategory, "bobSpeed", 9.0D).getDouble(9.0D);
		cfg_ClientCamera_SprintBobMultiplier = (float) lconf.get(cameraCategory, "sprintBobMultiplier", 1.25D).getDouble(1.25D);
		cfg_ClientCamera_ADSBobMultiplier = (float) lconf.get(cameraCategory, "adsBobMultiplier", 0.35D).getDouble(0.35D);
		cfg_ClientCamera_FovInertiaEnabled = lconf.get(cameraCategory, "fovInertiaEnabled", true).getBoolean(true);
		cfg_ClientCamera_FovLerpSpeed = (float) lconf.get(cameraCategory, "fovLerpSpeed", 0.12D).getDouble(0.12D);
		cfg_ClientCamera_SprintFovBoost = (float) lconf.get(cameraCategory, "sprintFovBoost", 3.0D).getDouble(3.0D);
		cfg_ClientCamera_ADSFovSpeed = (float) lconf.get(cameraCategory, "adsFovSpeed", 0.22D).getDouble(0.22D);
		cfg_ClientCamera_ShakeEnabled = lconf.get(cameraCategory, "shakeEnabled", true).getBoolean(true);
		cfg_ClientCamera_MaxShakePitch = (float) lconf.get(cameraCategory, "maxShakePitch", 5.0D).getDouble(5.0D);
		...
		cfg_ClientCamera_DamageShakeMultiplier = (float) lconf.get(cameraCategory, "damageShakeMultiplier", 0.7D).getDouble(0.7D);
		cfg_ClientCamera_CustomHurtCameraEnabled = lconf.get(cameraCategory, "customHurtCameraEnabled", true).getBoolean(true);
		cfg_ClientCamera_ReplaceVanillaHurtCamera = lconf.get(cameraCategory, "replaceVanillaHurtCamera", false).getBoolean(false);
		cfg_ClientCamera_DebugCamera = lconf.get(cameraCategory, "debugCamera", false).getBoolean(false);
