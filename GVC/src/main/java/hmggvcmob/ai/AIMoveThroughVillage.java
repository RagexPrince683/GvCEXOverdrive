			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
							this.theEntity.getNavigator().setBreakDoors(false);
							((IGVCmob)this.theEntity).getMoveToPositionMng().setMovingSpeed(1);
							((IGVCmob)this.theEntity).getMoveToPositionMng().getMoveToPos().set(vec3.xCoord, vec3.yCoord, vec3.zCoord);
							this.theEntity.getNavigator().setBreakDoors(flag);
							return true;
						}
					}
